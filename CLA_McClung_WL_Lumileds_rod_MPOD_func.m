function [maxrsq] = CLA_McClung_WL_Lumileds_rod_MPOD_func(rodY, ofY, ofB, rodB, mp, ma,fileStruct)
    ...
    CLA_B = CLA_rod_both_MPOD_optimization_1luxspd(B, lux_B, rodY, ofY, ofB, rodB, mp, ma,fileStruct);
