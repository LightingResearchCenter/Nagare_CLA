function [maxrsq ]  = generateMonochromaticSpectralResponseOfModel_Func_Test3(rodY, ofY, ofB, rodB, mp, ma,ivdb,fileStruct,TFplot)
...
waveBT = BandT(:,1);
BT = BandT(:,2);
wave = (420:1:600)'; % Wavelength range for calculations
