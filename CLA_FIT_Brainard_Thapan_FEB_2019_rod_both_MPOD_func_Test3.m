...
CLA_A = CLA_rod_both_MPOD_calculation_Test2(A, rodY, ofY, ofB, rodB, mp, ma,ivbd,g,fileStruct,testA2,testA3);
...
CLA_B = CLA_rod_both_MPOD_calculation_Test2(B, rodY, ofY, ofB, rodB, mp, ma,ivbd,g,fileStruct,testA2,testA3);
%% Compute logistic
