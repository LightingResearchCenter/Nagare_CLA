...
ofYRange = 0.05:0.05:0.5;   % ofY = 1 for original model ON WARM SIDE

ofBtest = 0.7;%0.81;%
%ofBRange =ofBtest:0.5:ofBtest;  
ofBRange = 0.5:0.05:1.5;   % ofB = 1 for original model ON COOL SIDE

rodYtest = 3.5;%1.1;%
%rodYRange =rodYtest-.5:0.5:rodYtest+.5;   
rodYRange = 0.05:0.05:0.5;   % rodY = 0 for original model
        ...
        for iOFB = ofBRange
            for irodB = rodBRange
                for imp = mpRange
                    ...
                    rsqs(1) = CLA_McClung_WL_Lumileds_rod_MPOD_func_Test2(irodY,iOFY,iOFB,irodB,imp,ima,fileStruct);
...
%                     rsq = CLA_McClung_WL_Lumileds_Cool_rod_MPOD_func(irodY,iOFY,iOFB,irodB,imp,ima,fileStruct); % no ofb yet
                    ...
                    rsqs(2) = CLA_FIT_Brainard_Thapan_FEB_2019_rod_both_MPOD_func_Test2(irodY,iOFY,iOFB,irodB,imp,ima,fileStruct);
