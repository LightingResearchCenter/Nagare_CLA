        ...
        for iOFB = ofBRange
            for irodB = rodBRange
                for imp = mpRange
                    ...
                    rsq = CLA_McClung_WL_Lumileds_rod_MPOD_func(irodY,iOFY,iOFB,irodB,imp,ima);
%                     rsq = CLA_McClung_WL_Lumileds_warm_4K_rod_MPOD_func(irodY,iOFY,iOFB,irodB,imp,ima);                    
%                     rsq = CLA_McClung_WL_Lumileds_Cool_rod_MPOD_func(irodY,iOFY,iOFB,irodB,imp,ima); % no ofb yet

%                     rsq = CLA_FIT_Brainard_Thapan_FEB_2019_rod_both_MPOD_func(irodY,iOFY,iOFB,irodB,imp,ima); %
% 
                        if rsq > maxrsq
                            maxrsq = rsq
                            rodYBest = irodY;
